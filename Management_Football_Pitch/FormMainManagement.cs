...
{
    public partial class FormMainManagement : Form
    {
        ...
        {
            int i = ran.Next(ThemeColor.ColorList.Count);

            while (i == tmp_index)
            {
                i = ran.Next(ThemeColor.ColorList.Count);
            }

            tmp_index = i;
            string color = ThemeColor.ColorList[i];
        ...
        {
            OpenChildForm(new fLichSan(), sender);
        }
